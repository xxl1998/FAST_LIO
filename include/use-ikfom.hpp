...
static MTK::get_cov<process_noise_ikfom>::type process_noise_cov()
{
...
static Eigen::Matrix<double, 24, 1> get_f(state_ikfom &s, const input_ikfom &in)
{
...
static Eigen::Matrix<double, 24, 23> df_dx(state_ikfom &s, const input_ikfom &in)
{
...
static Eigen::Matrix<double, 24, 12> df_dw(state_ikfom &s, const input_ikfom &in)
{
...
static vect3 SO3ToEuler(const SO3 &orient)
{
